...
func commonSetup() (*runtime.Scheme, reconcile.Request, *v1alpha1.SearchOperator, *corev1.Secret) {
	...
	return testScheme, req, testSearchOperator, testSecret
}
...
func Test_secretCreatedWithOwnerRef(t *testing.T) {
	testScheme, req, searchOperator, testSecret := commonSetup()
